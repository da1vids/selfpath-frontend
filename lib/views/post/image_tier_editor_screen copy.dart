        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // 👇 Description input shown always
              TextField(
              ...
              // 👇 Only show title & credits if not the first tier
              if (_tierCount > 0) ...[
                TextField(
              ...
              ElevatedButton(
                onPressed: () {
                  final label =
                      _tierCount == 0 ? "Free" : labelController.text.trim();
          ...
          */
                    ...
                    Padding(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () async {
                          final result = await _showTierDetailsDialog(context);
                          ...
                          print(
                            "🔍 Preview blurred image file: ${blurredImage.path}",
                          );
                          await showDialog(
                            context: context,
                            builder:
                          ...
                          if (_tierCount == 0) {
                            ...
                            // Create new post with free tier
                            ...
                            // Upload all new tiers (if multiple are queued)

                            for (final tier in _tiers) {
                              final response =
                                  await CreatePostService.uploadTier(
                                    imageFile: blurredImage,
