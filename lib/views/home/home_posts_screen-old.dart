...
class _HomePostsScreenState extends State<HomePostsScreen>
  ...
  Future<void> _unlockTier(
    ...
    if (result['success']) {
      ...
      if (_currentPlayingIndex == index && asset.endsWith('.mp4')) {
        ...
        final newController =
            asset.startsWith('http')
                ? VideoPlayerController.network(asset)
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Unlocked for $cost credits')));
    } else {
      ScaffoldMessenger.of(
        context,
          ...
          mediaWidget =
              isAssetImage
                  ...
                  : CachedNetworkImage(
                    ...
                    errorWidget:
                        (_, __, ___) => Icon(Icons.error, color: Colors.white),
                  );
        }
          ...
          children: [
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  // 👁 Eye (Views / Unlocks)
                  if (post['tiers'] != null && post['tiers'].isNotEmpty)
                    GestureDetector(
                      onTap: () {
                    ...
                    _videoController != null
                        ? ValueListenableBuilder<VideoPlayerValue>(
                          ...
                          builder: (context, value, child) {
                            final totalDuration = value.duration.inMilliseconds;
